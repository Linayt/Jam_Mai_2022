...
[CustomEditor(typeof(EventsOnDestroy))]
public class EventsOnDestroyEditor : Editor
{
	...
	[Tooltip("Used to check public variables from the target class")]
	private EventsOnDestroy myObject;
	...
	{
		myObject = (EventsOnDestroy)target;
	...
	private void DisplayToolbarMenu()
	{
		...
		{
			toolBarTab = GUILayout.Toolbar(toolBarTab, new string[] {"Events"}, GUILayout.MinHeight(25));
