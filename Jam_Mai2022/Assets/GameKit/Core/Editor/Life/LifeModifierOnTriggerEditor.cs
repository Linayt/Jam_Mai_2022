...
[CustomEditor(typeof(LifeModifierOnTrigger))]
public class LifeModifierOnTriggerEditor : Editor
{
    [Tooltip("Used to check public variables from the target class")]
    private LifeModifierOnTrigger myObject;
    ...
    {
        myObject = (LifeModifierOnTrigger)target;
